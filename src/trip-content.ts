...
export type PhotoInspiration = {
  title: string
  mood: string
  spots: Array<{ location: string; idea: string; image?: ImageAsset }>
}
...
> = [
  ...
  },
  {
    ...
    subtotal: '₽612 410–₽684 532 (¥1 188 786–¥1 328 786)',
...
export const recommendedTier = {
  title: 'Два сценария — одна атмосфера',
  why: 'Один вариант — стиль без переплаты, в 1.5–2× дешевле. Другой — максимум атмосферы и видов. Оба работают.',
  subtotal: 'Дизайн-оптимум ₽308 K (¥598 000) · Premium ₽586 K (¥1 138 100)',
  atmosphereNote:
    ...
    photoInspo: [
      {
        ...
        spots: [
          { location: 'Shibuya Crossing', idea: 'длинная выдержка сверху (Shibuya Sky или Starbucks 2F) — потоки людей как река; или снизу — один зонт среди сотен', image: { src: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Перекрёсток Сибуя ночью с потоками людей и неоном', creditLabel: 'Shibuya Crossing / Jezael Melgoza', creditUrl: 'https://unsplash.com/photos/aerial-photo-of-people-crossing-pedestrian-lane-layMbSJ3YOE' } },
          { location: 'Shinjuku Kabukicho', idea: 'неоновые переулки, силуэты, дождь на асфальте — Blade Runner наяву; лучше после 22:00', image: { src: 'https://images.unsplash.com/photo-1542931287-023b922fa89b?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Неоновые вывески в переулке Кабукитё ночью', creditLabel: 'Kabukicho neon / Jezael Melgoza', creditUrl: 'https://unsplash.com/photos/neon-lights-kabukicho' } },
          { location: 'Shimokitazawa переулки', idea: 'винтажные вывески, велосипеды, кошки на подоконниках — тихий андеграунд без пафоса', image: { src: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Тихий переулок Симокитадзавы с велосипедами и вывесками', creditLabel: 'Shimokitazawa / Jérémy Stenuit', creditUrl: 'https://unsplash.com/photos/japan-street' } },
          { location: 'Akihabara', idea: 'вертикальные вывески, провода, мерцающие экраны — максимальная визуальная перегрузка; хорошо в дождь', image: { src: 'https://images.unsplash.com/photo-1570521462033-3015e76e7432?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Яркие вертикальные вывески Акихабары в дождь', creditLabel: 'Akihabara / Erik Eastman', creditUrl: 'https://unsplash.com/photos/akihabara-tokyo-signs' } },
          { location: 'Tsukiji у прилавков', idea: 'руки, рыба, пар, ножи — честная документалка; снимайте не людей, а жесты и текстуры', image: { src: 'https://images.unsplash.com/photo-1580442151529-343f2f6e0e27?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Рыбный прилавок на рынке Цукидзи', creditLabel: 'Tsukiji Market / Agathe Marty', creditUrl: 'https://unsplash.com/photos/tsukiji-market-fish' } },
        ],
      },
      {
        ...
        spots: [
          { location: 'Omotesando на рассвете', idea: 'пустая архитектурная авеню — бетон Tadao Ando, стекло Dior, тени на тротуаре; идеальный editorial backdrop', image: { src: 'https://images.unsplash.com/photo-1480796927426-f609979314bd?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Архитектурный фасад на Омотэсандо в утреннем свете', creditLabel: 'Omotesando / Jezael Melgoza', creditUrl: 'https://unsplash.com/photos/tokyo-architecture' } },
          { location: 'Tokyo Station фасад', idea: 'красный кирпич + симметрия; full-length в центре площади, когда пусто — европейский glamour', image: { src: 'https://images.unsplash.com/photo-1513407030348-c983a97b98d8?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Фасад токийского вокзала из красного кирпича ночью', creditLabel: 'Tokyo Station / Sora Sagano', creditUrl: 'https://unsplash.com/photos/tokyo-station-facade' } },
          { location: 'Daikanyama T-Site', idea: 'белые стены книжного + зелень; расслабленный luxury, кофе в кадре, естественный свет', image: { src: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Книжный Tsutaya в Дайканьяме с зеленью', creditLabel: 'Daikanyama / Su San Lee', creditUrl: 'https://unsplash.com/photos/japan-garden' } },
          { location: 'Meiji Jingū torii', idea: 'гигантские тории + гравийная дорожка — масштаб человека на фоне; утром без толпы', image: { src: 'https://images.unsplash.com/photo-1551641506-ee5bf4cb45f1?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Гигантские деревянные тории Мэйдзи Дзингу', creditLabel: 'Meiji Jingu / Redd F', creditUrl: 'https://unsplash.com/photos/meiji-jingu-torii' } },
    ...
    photoInspo: [
      {
        ...
        spots: [
          { location: 'Fushimi Inari тории', idea: 'бесконечный тоннель красных ворот — перспектива, повторение, одинокая фигура вдали; снимайте на рассвете', image: { src: 'https://images.unsplash.com/photo-1478436127897-769e1b3f0f36?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Тысячи красных тории Фусими Инари уходят вверх по горе', creditLabel: 'Fushimi Inari / Lin Mei', creditUrl: 'https://unsplash.com/photos/fushimi-inari-torii-gates' } },
          { location: 'Pontocho переулок', idea: 'узкая улочка шириной в два шага — бумажные фонари, деревянные фасады, тень гейши за дверью', image: { src: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Узкий переулок Понтотё с бумажными фонарями вечером', creditLabel: 'Pontocho / Su San Lee', creditUrl: 'https://unsplash.com/photos/pontocho-alley-kyoto' } },
          { location: 'Nishiki Market', idea: 'цвет, текстура, еда крупным планом — маринованные овощи, рыба, моти; руки продавцов', image: { src: 'https://images.unsplash.com/photo-1553621042-f6e147245754?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Цветные прилавки рынка Нисики с едой', creditLabel: 'Nishiki Market / Lysander Yuen', creditUrl: 'https://unsplash.com/photos/nishiki-market-kyoto' } },
          { location: 'Philosopher\'s Path', idea: 'канал, мост, кошка на камне — дзен-минимализм; медленная серия, один объект на кадр', image: { src: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Тропа философа вдоль канала с зеленью', creditLabel: 'Philosopher Path / Clay Banks', creditUrl: 'https://unsplash.com/photos/philosophers-path-kyoto' } },
          { location: 'Kiyomizu-dera терраса', idea: 'панорама Киото с деревянной террасы — город в дымке, крыши храмов, зелень; на закрытии — без людей', image: { src: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Вид с террасы Киёмидзу-дэра на Киото в зелени', creditLabel: 'Kiyomizu-dera / Sorasak', creditUrl: 'https://unsplash.com/photos/kiyomizu-dera-view' } },
        ],
      },
      {
        title: 'Fashion / editorial',
        ...
        spots: [
          { location: 'Yasaka Pagoda / Yasaka-dori', idea: 'пагода в конце каменной улочки — идеальная глубина кадра; кимоно + утренний свет = обложка', image: { src: 'https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Пагода Ясака в конце улочки с каменными фонарями', creditLabel: 'Yasaka Pagoda / Tianshu Liu', creditUrl: 'https://unsplash.com/photos/yasaka-pagoda-street' } },
          { location: 'Ishibei-koji', idea: 'каменные стены и мох — приглушённый, текстурный фон; хорошо для close-up и деталей одежды', image: { src: 'https://images.unsplash.com/photo-1558862107-d49ef2a04d72?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Каменный переулок Исибэй-кодзи с мхом и фонарями', creditLabel: 'Ishibei-koji / Andre Benz', creditUrl: 'https://unsplash.com/photos/ishibei-koji-kyoto' } },
          { location: 'Бамбуковая роща', idea: 'вертикальные линии бамбука + мягкий рассеянный свет — природный софтбокс; снимайте в профиль', image: { src: 'https://images.unsplash.com/photo-1580619305218-8423a7ef79b4?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Бамбуковая роща Арасияма с зелёным светом', creditLabel: 'Bamboo Grove / Liam Burnett-Blue', creditUrl: 'https://unsplash.com/photos/arashiyama-bamboo-grove' } },
          { location: 'Shirakawa canal', idea: 'ива + мост + вода — романтический кадр в синий час; пара в координированных образах', image: { src: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Канал Сиракава в Гионе с ивой и фонарями вечером', creditLabel: 'Shirakawa / Sorasak', creditUrl: 'https://unsplash.com/photos/kyoto-canal' } },
          { location: 'Kodai-ji сад', idea: 'сухой сад камней + чистое пространство — минималистичный фон для сильного образа', image: { src: 'https://images.unsplash.com/photo-1502899576159-f224dc2349fa?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Дзен-сад камней с аккуратно разровненным гравием', creditLabel: 'Zen garden / Ryoji Iwata', creditUrl: 'https://unsplash.com/photos/zen-rock-garden-kyoto' } },
          { location: 'Nishijin weaving district', idea: 'кимоно-мастерские, текстильные текстуры на стенах — fashion meets craft; почти без туристов', image: { src: 'https://images.unsplash.com/photo-1505069190533-da1c9af13346?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Традиционные кимоно в мастерской Нисидзин', creditLabel: 'Nishijin / Finan Akbar', creditUrl: 'https://unsplash.com/photos/nishijin-textiles-kyoto' } },
        ],
      },
    ],
    hotels: [
    ...
    photoInspo: [
      {
        ...
        spots: [
          { location: 'Dotonbori ночью', idea: 'гигантские 3D-вывески (краб, осьминог, Glico) + толпа + отражения в канале — чистый визуальный перегруз', image: { src: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Неоновые вывески Дотонбори с отражениями в канале ночью', creditLabel: 'Dotonbori / Alex Knight', creditUrl: 'https://unsplash.com/photos/dotonbori-osaka-neon' } },
          { location: 'Shinsekai', idea: 'ретро-район с башней Tsūtenkaku — выцветшие вывески, пиво, кушикацу; ностальгия и грубая фактура', image: { src: 'https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Ретро-район Синсэкай с башней Цутэнкаку и яркими вывесками', creditLabel: 'Shinsekai / Akhil Lincoln', creditUrl: 'https://unsplash.com/photos/shinsekai-osaka' } },
          { location: 'Kuromon Market', idea: 'морепродукты крупным планом — уни на льду, гриль с дымом, руки с палочками; цвет и текстура', image: { src: 'https://images.unsplash.com/photo-1553621042-f6e147245754?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Свежие морепродукты на прилавках рынка Куромон', creditLabel: 'Kuromon Market / Lysander Yuen', creditUrl: 'https://unsplash.com/photos/kuromon-market-osaka' } },
          { location: 'Hozenji Yokocho', idea: 'моховая статуя в тёмном переулке — контраст тишины и хаоса Дотонбори в 20 метрах', image: { src: 'https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Тёмный переулок Хозэндзи с каменным фонарём и мхом', creditLabel: 'Hozenji / Banter Snaps', creditUrl: 'https://unsplash.com/photos/hozenji-yokocho-osaka' } },
          { location: 'Tennoji / Abeno', idea: 'смешение старого и нового — торговые аркады, храмы, небоскрёб Harukas; вертикальные контрасты', image: { src: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Небоскрёб Abeno Harukas над крышами Тэннодзи', creditLabel: 'Tennoji / Alex Knight', creditUrl: 'https://unsplash.com/photos/tennoji-abeno-osaka' } },
        ],
      },
      {
        title: 'Fashion / editorial',
        ...
        spots: [
          { location: 'Nakanoshima riverfront', idea: 'европейские мосты + река + утренний свет — чистый фон для smart casual; тренч + кофе в руке', image: { src: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Река Наканосима с мостами в утреннем свете', creditLabel: 'Nakanoshima / Alex Knight', creditUrl: 'https://unsplash.com/photos/nakanoshima-osaka-river' } },
          { location: 'Tombori Riverwalk', idea: 'неон отражается в воде — вечерний fashion с цветным светом; чёрная одежда + яркий фон', image: { src: 'https://images.unsplash.com/photo-1584505489290-96eb4e406d08?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Набережная Томбори с лодками и неоновыми отражениями', creditLabel: 'Tombori / Juliana Barquero', creditUrl: 'https://unsplash.com/photos/tombori-riverwalk-osaka' } },
          { location: 'Umeda Sky эскалатор', idea: 'футуристический эскалатор в небо — масштаб, линии, sci-fi aesthetic; снимайте снизу вверх', image: { src: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&fm=jpg&q=60&w=800', alt: 'Футуристический эскалатор Умеда Скай Билдинг', creditLabel: 'Umeda Sky / Alex Knight', creditUrl: 'https://unsplash.com/photos/umeda-sky-building-osaka' } },
...
export const lastNote = {
  eyebrow: 'НАПОСЛЕДОК',
  title: 'Осталось зафиксировать',
  body: 'Если хотите довести это до совершенства: после бронирования отелей и 4–6 ключевых бронирований следующий шаг — подневный сценарий с точным порядком районов, временем на переезды, одеждой на каждый день и запасным планом на дождь.',
  image: osakaNeon,
}
